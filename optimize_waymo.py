...
from src.optimizer_waymo import OptimizerWaymo
from src.data_waymo import WaymoData
...
if __name__ == '__main__':
    ...
    # arg_parser.add_argument("--config_file", dest="config_file", default="jsonfiles/autorfmix.waymo.car.json")
    arg_parser.add_argument("--config_file", dest="config_file", default="jsonfiles/supnerf.waymo.car.json")
    ...
    arg_parser.add_argument("--val-small", dest="val_small", action='store_true',
                            help="use small validation set for quick test")
    ...
    waymo_dataset = WaymoData(
        hpams,
        waymo_data_dir,
        split='val_small' if args.val_small else 'val',
        debug=False,
    ...
    optimizer = OptimizerWaymo(args.gpu, waymo_dataset, hpams,
